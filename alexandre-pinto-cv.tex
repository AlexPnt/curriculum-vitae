...
\textsc{\small{Nov 2016 - }} & \textbf{Backend Developer -} \textbf{\href{http://www.ubiwhere.com/en/}{Ubiwhere}} \\
 & Development of smart solutions for smart cities in areas such as mobility, tourism, energy and efficient resource management.  \\
 & Technologies used: Django, Djang REST Framework, Python Ecosystem, Ionic, Docker, GNU/Linux, git. \\
...
\textsc{\small{Oct 2015 - Jul 2016}} & \textbf{Research Intern -} \textbf{\href{https://www.inesctec.pt/ip-en?set_language=en\&cl=en}{INESCTEC}} / \textbf{\href{https://www.cisuc.uc.pt/}{CISUC}} \\
 & Development of a filter that classifies public social data according to their potential relevance to a general audience, filtering out irrelevant information and relying primarily on linguistic features and confirm if relevance can be predicted from a set of journalistic criteria.\\
 & Technologies used: scikit-learn, NLTK, numPy, matplotlib, git.\\
...
\textsc{\small{Oct 2013 - Mar 2014}} & \textbf{Software Developer -} \textbf{\href{http://ipn.pt/laboratorio/LIS}{Pedro Nunes Institute (IPN)}} \\
 & Helped maintaining and developing new features for the information systems.\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize*}
\item{\textbf{Programming Languages:} Proficient in Java, Python and C. Additional knowledge in ActionScript 3.0 and Matlab.}
...
\item{\textbf{Web Frameworks:} Struts2, Django, Django Rest Framework, AngularJS 1, Bottle. Familiar with Rails.}
\item{\textbf{Hybrid Mobile App Frameworks:} Ionic.}
\item{\textbf{Machine Learning Tools:} Weka, scikit-learn, SciPy stack (NumPy, Matplotlib, pandas), seaborn. }
\item{\textbf{Databases:} Familiar with MySQL, Oracle, PostgreSQL.}
\item{\textbf{Development Tools:} Eclipse, Netbeans, IntelliJ, PyCharm, Sublime Text Editor.}
...
\begin{itemize}
\item
	\ressubheading{{\colorhref[black]{http://rdcu.be/wAl5}{Predicting the Relevance of Social Media Posts Based on Linguistic Features}}}{}{Alexandre Pinto and Gonçalo Oliveira, H, and Alves, A., New Generation Computing, 2017}{}
