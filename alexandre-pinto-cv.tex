...
& At WIT I am responsible for running machine learning experiments, in order to build proof-of-concept prototypes and deploy them to production, with performance and scalability in mind. I work mostly in the Natural Language Processing (NLP) sub-field of Artificial Intelligence, using state-of-art methods. My daily work is composed of research and practical implementation of machine learning solutions. 
