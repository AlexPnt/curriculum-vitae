...
Software engineer competent in implementing backend systems & \href{https://github.com/alexpnt}{\small \faGithub{} | alexpnt}\\
with a focus on machine learning services. &  \href{https://www.linkedin.com/in/alexandre-pinto}{\small \faLinkedin{} | alexandre-pinto}\\
Enjoys tackling engineering problems with good system design choices,\\ that strive for scalability and  efficient resource management.
\end{tabular*}}
\\
...
\item{\textbf{Machine Learning Tools:} Kera/Tensorflow, PyTorch, scikit-learn, XGBoost, SciPy stack (NumPy, Matplotlib, pandas), seaborn, Weka.}
